  ...
  return (
    ...
    {audio ? (
      <div className="audio-container flex items-center justify-center gap-3">
        <CiTrash size={23} color="#4E5E78" style={{marginLeft:"5px"}} onClick={cancelRecording} />
        <Waveform url={audio} />
      </div> 
      ) : 
    ...
    <>
    <br />
          <FcSynchronize size={23} color="#BDBDBD" style={{marginLeft:" 20px",marginRight:"10px"}} onClick={restartRecording}  />
          <PiWaveformBold size={23} color="#22C563" style={{marginRight:"2px  "}} />
        <div className='  flex flex-row gap-2'>

        <p className='text-green-500 font-semibold w-9'>{formatTime(elapsedSeconds)}</p>
        <div className='mr-8'>
